...
const RemovedChangeView = ({
  ...
  return (
    <div
      key={index}
      className="flex  flex-col space-x-8 md:flex-row md:space-x-20"
    >
      <div
        className={` flex w-full   justify-between rounded-[30px] bg-white px-4  py-2 text-sm   font-bold text-customRed md:space-x-4  `}
      >
        <p>
      ...
      {/* <div
        className={` pointer-events-none  hidden w-full justify-between rounded-[30px] bg-[#E0E8F0] px-4 py-2   text-sm font-bold md:flex md:w-1/2 md:space-x-4`}
      >
